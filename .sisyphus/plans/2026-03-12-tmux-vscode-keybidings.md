...
This filename contains a typo ("keybidings"). Canonical plan file:
`.sisyphus/plans/2026-03-12-tmux-vscode-keybindings.md`

The content below is a copy of the canonical plan so automation can still run.
