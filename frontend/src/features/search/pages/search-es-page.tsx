...
import { Input, Card, List, Slider, Space, Typography, Row, Col, Button, Spin, Checkbox, Switch } from "antd";
...
export default function SearchESPage() {
  ...
  const [bm25Only, setBm25Only] = useState(true);
                    ...
                    {field.enabled && (
                      <div style={{ paddingLeft: "32px" }}>
                        <Slider
                          ...
                          step={0.1}
                          value={field.weight}
                          onChange={(value: number) => handleWeightChange(index, value)}
                          marks={{
                            0: "0.0",
                            1.0: "1.0",
                            2.0: "2.0",
