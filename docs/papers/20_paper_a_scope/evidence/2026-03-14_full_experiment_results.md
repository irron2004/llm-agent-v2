...
- **특징**:
  ...
  - gold hit도 크게 하락: 378/578(65%) → 228/578(39.4%)
...
| 시스템 | 검색 방식 | 필터 | Oracle? | cont@10 (masked) | gold_strict (masked) | gold_loose (masked) |
|--------|-----------|------|---------|------------------|---------------------|---------------------|
| B0 | BM25 | 없음 | - | 0.473 | 287/578 (49.7%) | 343/578 (59.3%) |
| B1 | Dense kNN | 없음 | - | 0.730 | 228/578 (39.4%) | 261/578 (45.2%) |
| B2 | Hybrid RRF | 없음 | - | 0.585 | 351/578 (60.7%) | 380/578 (65.7%) |
| B3 | Hybrid+Rerank | 없음 | - | 0.584 | 351/578 (60.7%) | 380/578 (65.7%) |
| B4 | Hybrid+Rerank | Device(oracle) | Yes | 0.001 | 527/578 (91.2%) | 532/578 (92.0%) |
| B4.5 | Hybrid+Rerank | Device+Shared(oracle) | Yes | 0.001 | 406/578 (70.2%) | 439/578 (76.0%) |
| P6 | Hybrid+Rerank | Soft(λ=0.05) | - | 0.649 | 351/578 (60.7%) | 380/578 (65.7%) |
| P7 | Hybrid+Rerank | Soft(adaptive) | - | 0.649 | 351/578 (60.7%) | 380/578 (65.7%) |
...
| B1_masked | 0.730 | 228/578 (39.4%) | 261/578 (45.2%) |
| B2_masked | 0.585 | 351/578 (60.7%) | 380/578 (65.7%) |
| B3_masked | 0.584 | 351/578 (60.7%) | 380/578 (65.7%) |
...
2. **B1_masked 최악**: Dense는 masking에 가장 취약 (cont 0.730, gold 39.4%)
...
| B1_masked | 0.685 | 221/429 (51.5%) | 248/429 (57.8%) |
| B3_masked | 0.481 | 341/429 (79.5%) | 357/429 (83.2%) |
...
| B1_masked | 0.859 | 7/149 (4.7%) | 13/149 (8.7%) |
| B3_masked | 0.881 | 10/149 (6.7%) | 23/149 (15.4%) |
...
```
B1_masked: cont 0.730, gold 39.4%
B2_masked (BM25+Dense): cont 0.585, gold 65.7%
B0_masked (BM25만): cont 0.473, gold 59.3%
```
...
#### ~~주의 2: Implicit/ambiguous query 실험 미완료~~ → **완료 (Section 13 참조)**

- **완료**: 628 implicit 쿼리(578 implicit + 50 trap) × 10 conditions 실험 완료
- **결과**: B4 strict=84.7%, baseline 수렴 확인, masking methodology 검증됨
- **상세**: Section 13 참조
...
**답변 요약**:
- BM25: 47.3% contamination (masked, no filter)
- Dense: 73.0% contamination (masked, no filter)
- Hybrid+Rerank: 58.4% contamination (masked, no filter)
...
| ~~Implicit/ambiguous 미실험~~ | ~~v0.7 구성했으나 본격 실험 미실시~~ → **완료** (Section 13) | equip-level 전략은 별도 과제 |
...
- [x] Equip query disambiguation 전략 설계 → 논문 Section 6.4에 3가지 전략 서술 (context routing, group filter, LLM inference)
...
|--------|---------|-------------|------------|-----|
| B0_masked | 0.473 | 287/578 (49.7%) | 343/578 (59.3%) | 0.355 |
| B1_masked | 0.730 | 228/578 (39.4%) | 261/578 (45.2%) | 0.245 |
| B2_masked | 0.585 | 351/578 (60.7%) | 380/578 (65.7%) | 0.413 |
| B3_masked | 0.584 | 351/578 (60.7%) | 380/578 (65.7%) | 0.335 |
| B4_masked | 0.001 | 527/578 (91.2%) | 532/578 (92.0%) | 0.562 |
| B4.5_masked | 0.001 | 406/578 (70.2%) | 439/578 (76.0%) | 0.421 |

*Note: MRR은 strict gold 기준 첫 번째 hit의 reciprocal rank. Oracle vs Parser 비교(Section 7.4)의 MRR=0.846은 BM25+loose gold 기준이므로 본 표와 기준이 다름.*

### A.2 scope_observability별 B4 효과

| scope_obs | B3_masked cont | B4_masked cont | B3_masked gold | B4_masked gold | delta gold |
|-----------|---------------|---------------|----------------|----------------|------------|
| explicit_device | 0.481 | 0.001 | 357/429 (83.2%) | 416/429 (97.0%) | +13.8%p |
| explicit_equip | 0.881 | 0.000 | 23/149 (15.4%) | 116/149 (77.9%) | +62.5%p |
| ALL | 0.584 | 0.001 | 380/578 (65.7%) | 532/578 (92.0%) | +26.3%p |
...
### A.4 Recall@k 및 NDCG@10 (masked, deduped, strict gold)

#### Explicit-Masked (n=578)

| System | R@1 | R@3 | R@5 | R@10 | NDCG@10 | MRR |
|--------|-----|-----|-----|------|---------|-----|
| B0 | 28.5% | 41.0% | 43.8% | 49.7% | 0.282 | 0.356 |
| B1 | 18.2% | 29.8% | 34.9% | 39.4% | 0.192 | 0.250 |
| B2 | 32.7% | 48.3% | 55.5% | 60.7% | 0.325 | 0.420 |
| B3 | 22.3% | 40.1% | 50.0% | 60.7% | 0.290 | 0.340 |
| B4 | 41.3% | 65.9% | 82.5% | 91.2% | 0.588 | 0.568 |
| B4.5 | 31.7% | 47.4% | 58.8% | 70.2% | 0.390 | 0.425 |
| P6 | 22.3% | 40.1% | 51.7% | 60.7% | 0.292 | 0.343 |
| P7 | 22.3% | 40.1% | 51.4% | 60.7% | 0.291 | 0.342 |
...
*Note: top_doc_ids 중복 제거 후 계산. 원본 데이터에 cross-index join으로 인한 중복 존재.*

### A.5 Latency 측정 (BM25, n=50 sampled queries)

| Condition | Client p50 | Client p95 | ES internal |
|-----------|-----------|-----------|-------------|
| No filter | 2.3ms | 3.3ms | <1ms |
| Device filter | 2.2ms | 2.9ms | <1ms |

*508 document corpus에서는 latency 차이 무의미. 대규모 코퍼스에서는 pre-filtering이 후보 수 감소로 latency 이점 예상.*

---

## 잔여 TODO (논문 외)

- [ ] ColBERT/SPLADE 실험 (추가 retrieval method 비교)
- [ ] 다른 도메인 검증 (의료, 자동차 등)
- [ ] LaTeX 변환 (학회 template 적용)
- [ ] Contamination heatmap figure 생성

---

*문서 생성: 2026-03-14*
*최종 업데이트: 2026-03-15 — Recall@k, NDCG, MRR(deduped), latency, 통계 검정 추가*
