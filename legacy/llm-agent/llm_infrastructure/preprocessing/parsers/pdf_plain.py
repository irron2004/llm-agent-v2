"""Lightweight PDF parser that relies on pdfplumber for text extraction."""

from __future__ import annotations

from typing import BinaryIO, Optional

from llm_infrastructure.preprocessing.base import (
    BaseParser,
    ParsedBlock,
    ParsedDocument,
    ParsedPage,
...
from llm_infrastructure.preprocessing.registry import register_parser
...
register_parser("pdf_plain", PlainPdfParser)
